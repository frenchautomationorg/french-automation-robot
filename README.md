...
<ul>
  <li>Newmips developer Studio - https://www.newmips.com/</li>
  <li>A custom Orchestrator that manages Business activities and dispatches automated tasks between connected Robots</li>
